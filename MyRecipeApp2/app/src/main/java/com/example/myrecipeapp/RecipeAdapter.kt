...
class RecipeAdapter(
    ...
    public var recipes: List<RecipeTable>,
    ...
    inner class MyViewHolder(itemView: View, private val navController: NavController) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(recipe: RecipeTable) {
            ...
            val predefinedImageResId = R.drawable.recipes
            // Set the predefined image for all recipes
            itemImage.setImageResource(predefinedImageResId)
