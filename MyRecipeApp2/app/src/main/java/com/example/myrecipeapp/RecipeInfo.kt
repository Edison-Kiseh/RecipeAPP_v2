...
class RecipeInfo : Fragment() {
    ...
    lateinit var binding: FragmentRecipeInfoBinding
...
//                }
    ...
    fun showPopupMenu(view: View, recipeId: Long) {
    ...
    fun manageTime(prepTime: String): String {
    ...
    fun updateColours(change: Boolean){
        if(change){
